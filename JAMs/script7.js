let musicas = [
    {titulo:'Hazy Shade of Winter (feat. Ray Toro)', artista:'Gerard Way', source:'music/Hazy Shade of Winter.mp3', img:'images/Gerard.png'},
];
...
let imagem = document.querySelector('.conteudo-player-imagem');
